        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          >
            <motion.div
              ...
              className="rounded-2xl border border-[rgba(160,175,255,0.15)] bg-gradient-to-br from-[#0D1824] to-[rgba(20,4,24,0.82)] p-6 backdrop-blur sm:p-8"
            >
              ...
              >
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full rounded-xl border ${
                      errors.name ? "border-red-500/50" : "border-[rgba(160,175,255,0.15)]"
                    } bg-[#08111A] px-4 py-3 text-white placeholder:text-white/35 focus:border-[#5B6BC4] focus:outline-none focus:ring-2 focus:ring-[#5B6BC4]/20`}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full rounded-xl border ${
                      errors.email ? "border-red-500/50" : "border-[rgba(160,175,255,0.15)]"
                    } bg-[#08111A] px-4 py-3 text-white placeholder:text-white/35 focus:border-[#5B6BC4] focus:outline-none focus:ring-2 focus:ring-[#5B6BC4]/20`}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full rounded-xl border border-[rgba(160,175,255,0.15)] bg-[#08111A] px-4 py-3 text-white placeholder:text-white/35 focus:border-[#5B6BC4] focus:outline-none focus:ring-2 focus:ring-[#5B6BC4]/20"
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className="w-full rounded-xl border border-[rgba(160,175,255,0.15)] bg-[#08111A] px-4 py-3 text-white focus:border-[#5B6BC4] focus:outline-none focus:ring-2 focus:ring-[#5B6BC4]/20"
                    >
                      {serviceOptions.map(option => (
                        <option key={option} value={option} className="bg-[#000000]">
                          {option}
                        </option>
                      ))}
                    </select>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className={`w-full rounded-xl border ${
                      errors.message ? "border-red-500/50" : "border-[rgba(160,175,255,0.15)]"
                    } bg-[#08111A] px-4 py-3 text-white placeholder:text-white/35 focus:border-[#5B6BC4] focus:outline-none focus:ring-2 focus:ring-[#5B6BC4]/20`}
                ...
                <button
                  ...
                  className="group relative w-full overflow-hidden rounded-full bg-gradient-to-r from-[#5B6BC4] to-[#5B6BC4] px-6 py-3.5 font-medium text-white transition-all hover:shadow-lg hover:shadow-[#5B6BC4]/20 disabled:opacity-50"
                >
                  <span className="relative z-10 flex items-center justify-center gap-2">
                    {formStatus === "submitting" ? (
                      <>
                        <div className="size-4 animate-spin rounded-full border-2 border-[#000000] border-t-transparent" />
                        Sending...
                      </>
                    ) : (
                      <>
          ...
          >
            ...
            {contactInfo.map((info) => {
              ...
              return (
                <motion.div
                  ...
                  variants={itemVariants}
                  whileHover={{ y: -2 }}
                  className="rounded-xl border border-[rgba(160,175,255,0.15)] bg-[#0D1824] p-6 transition-all duration-300 hover:border-[#5B6BC4]/30 hover:shadow-xl"
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      {info.details.map((detail, i) => (
                        <p key={i} className="mt-1 text-sm text-white/50">
                          {detail}
                        </p>
                      ))}
                      {info.action && (
                        <a
                          ...
                          className="mt-2 inline-flex items-center gap-1 text-sm text-[#5B6BC4] transition-all hover:gap-2"
                        >
                          {info.action.label}
            ...
            >
              <div className="flex items-center gap-2 mb-4">
                <MessageSquare className="size-5 text-[#5B6BC4]" />
                <h3 className="font-semibold text-white">Frequently Asked Questions</h3>
              </div>
              <div className="space-y-4">
                {faqs.map((faq, index) => (
                  <details key={index} className="group">
                    <summary className="cursor-pointer text-sm font-medium text-white/75 transition-colors hover:text-[#A0AFFF]">
                      {faq.question}
                    </summary>
                    <p className="mt-2 text-sm text-white/50 pl-4">
                      {faq.answer}
                    </p>
                  </details>
                ))}
            ...
            <motion.div
              variants={itemVariants}
              className="rounded-xl border border-[#5B6BC4]/20 bg-gradient-to-r from-[#5B6BC4]/10 to-transparent p-6 text-center"
            >
              <Sparkles className="mx-auto mb-3 size-8 text-[#5B6BC4]" />
              ...
              <div className="mt-4 flex justify-center gap-4">
                <a
                  ...
                  className="flex items-center gap-2 text-sm text-[#5B6BC4] hover:underline"
                >
