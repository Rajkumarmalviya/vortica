      ...
      <div className="relative">
        ...
        >
          <div className="grid gap-8 lg:grid-cols-[0.42fr_0.58fr] lg:items-end">
            ...
            >
              <div className="group relative overflow-hidden rounded-xl border border-white/10 bg-gradient-to-br from-white/[0.04] to-white/[0.02] p-5 transition-all duration-300 hover:border-[#8b5cf6]/30 hover:shadow-xl">
                <div className="rounded-lg bg-[#8b5cf6]/10 p-2 w-fit">
                  <Code2 className="size-5 text-[#8b5cf6]" />
                </div>
        ...
        >
          <motion.div variants={itemVariants} className="mb-8 text-center">
            <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2">
              <Award className="size-4 text-[#8b5cf6]" />
              <span className="text-xs font-medium uppercase tracking-wider text-[#a1a1aa]/70">
                Why Choose Us
              </span>
            </div>
