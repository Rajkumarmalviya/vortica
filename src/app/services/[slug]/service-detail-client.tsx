      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        >
          <div className="flex flex-col items-center text-center">
            <div className="mb-6 flex h-20 w-20 items-center justify-center rounded-2xl border border-[#8b5cf6]/30 bg-gradient-to-br from-[#8b5cf6]/20 to-[#8b5cf6]/5">
              <IconComponent className="size-10 text-[#8b5cf6]" />
            </div>

            <div className="mb-4 flex items-center gap-2 text-sm text-[#a1a1aa]/60">
              <Link href="/services" className="transition-colors hover:text-[#8b5cf6]">
                Services
              </Link>
              <ChevronRight className="size-3" />
              <span className="text-[#8b5cf6]">{service.title}</span>
            </div>
          ...
          {metrics.map((metric) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -4 }}
                className="rounded-xl border border-white/10 bg-gradient-to-br from-white/[0.04] to-white/[0.02] p-6 text-center transition-all duration-300 hover:border-[#8b5cf6]/30 hover:shadow-xl"
              >
                <div className="mb-3 flex justify-center">
                  <div className="rounded-lg bg-[#8b5cf6]/10 p-2">
                    <MetricIcon className="size-6 text-[#8b5cf6]" />
                  </div>
                </div>
              ...
              {service.outcomes.map((outcome) => (
                ...
                >
                  ...
                  <div className="relative flex items-start gap-3">
                    <CheckCircle2 className="mt-0.5 size-5 text-[#8b5cf6]" />
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {service.capabilities.map((capability) => (
                <motion.div
                  ...
                  variants={itemVariants}
                  whileHover={{ x: 4 }}
                  className="group rounded-xl border border-white/10 bg-gradient-to-br from-[rgba(36,14,48,0.72)] to-[rgba(20,4,24,0.82)] px-4 py-3.5 transition-all duration-300 hover:border-[#8b5cf6]/30"
                >
        ...
        >
          <motion.div variants={itemVariants} className="mb-6 text-center">
            <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2">
              <Rocket className="size-4 text-[#8b5cf6]" />
            ...
            {[
              ...
              return (
                <motion.div
                  ...
                  variants={itemVariants}
                  whileHover={{ y: -4 }}
                  className="group relative overflow-hidden rounded-xl border border-white/10 bg-gradient-to-br from-white/[0.04] to-white/[0.02] p-6 transition-all duration-300 hover:border-[#8b5cf6]/30 hover:shadow-xl"
                >
                  <div className="absolute right-4 top-4 text-4xl font-bold text-white/5">
                    {step.step}
                  </div>
                  <div className="relative">
                    <div className="w-fit rounded-lg bg-[#8b5cf6]/10 p-2">
                      <StepIcon className="size-5 text-[#8b5cf6]" />
                    </div>
              ...
              {relatedServices.map((relatedService) => {
                ...
                return (
                  <motion.div
                    ...
                    variants={itemVariants}
                    whileHover={{ y: -4 }}
                    className="group rounded-xl border border-white/10 bg-gradient-to-br from-white/[0.04] to-white/[0.02] p-6 transition-all duration-300 hover:border-[#8b5cf6]/30 hover:shadow-xl"
                  >
                    <div className="w-fit rounded-lg bg-[#8b5cf6]/10 p-2">
                      <RelatedIcon className="size-5 text-[#8b5cf6]" />
                    </div>
                    <h3 className="mt-4 text-lg font-semibold text-white transition-colors group-hover:text-[#8b5cf6]">
                    ...
                    <Link
                      ...
                      className="mt-4 inline-flex items-center gap-2 text-sm font-medium text-[#8b5cf6] transition-all hover:gap-3"
                    >
                      Learn More
        ...
        <motion.div
          ...
          className="mt-12 rounded-2xl bg-gradient-to-r from-[#8b5cf6]/10 via-[#6d28d9]/10 to-transparent p-8 text-center"
        >
