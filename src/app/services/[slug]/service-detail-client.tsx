      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        >
          <div className="flex flex-col items-center text-center">
            <div className="mb-6 flex h-20 w-20 items-center justify-center rounded-2xl border border-[#F3DB3F]/30 bg-gradient-to-br from-[#F3DB3F]/20 to-[#F3DB3F]/5">
              <IconComponent className="size-10 text-[#F3DB3F]" />
            </div>

            <div className="mb-4 flex items-center gap-2 text-sm text-[#ECD8D5]/60">
              <Link href="/services" className="transition-colors hover:text-[#F3DB3F]">
                Services
              </Link>
              <ChevronRight className="size-3" />
              <span className="text-[#F3DB3F]">{service.title}</span>
            </div>

            <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">
              {service.title}
            </h1>
            <p className="mt-4 max-w-3xl text-base leading-relaxed text-[#ECD8D5]/80 sm:text-lg">
              {service.summary}
            </p>

            <div className="mt-6 flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2">
              <Star className="size-4 text-[#F3DB3F]" />
              <span className="text-sm text-[#ECD8D5]/70">Trusted by 50+ innovative companies</span>
            </div>
          </div>
        </motion.div>
          ...
          {metrics.map((metric) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -4 }}
                className="rounded-xl border border-white/10 bg-gradient-to-br from-white/[0.04] to-white/[0.02] p-6 text-center transition-all duration-300 hover:border-[#F3DB3F]/30 hover:shadow-xl"
              >
                <div className="mb-3 flex justify-center">
                  <div className="rounded-lg bg-[#F3DB3F]/10 p-2">
                    <MetricIcon className="size-6 text-[#F3DB3F]" />
                  </div>
                </div>
              ...
              {service.outcomes.map((outcome) => (
                ...
                >
                  ...
                  <div className="relative flex items-start gap-3">
                    <CheckCircle2 className="mt-0.5 size-5 text-[#F3DB3F]" />
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {service.capabilities.map((capability) => (
                <motion.div
                  ...
                  variants={itemVariants}
                  whileHover={{ x: 4 }}
                  className="group rounded-xl border border-white/10 bg-gradient-to-br from-[rgba(36,14,48,0.72)] to-[rgba(20,4,24,0.82)] px-4 py-3.5 transition-all duration-300 hover:border-[#F3DB3F]/30"
                >
                  <div className="flex items-center gap-2">
                    <Sparkles className="size-4 text-[#F3DB3F]" />
                    <span className="text-sm text-[#ECD8D5]/80">{capability}</span>
                  </div>
                </motion.div>
              ))}
            </div>
        ...
        >
          <motion.div variants={itemVariants} className="mb-6 text-center">
            <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2">
              <Rocket className="size-4 text-[#F3DB3F]" />
            ...
            {[
              ...
              return (
                <motion.div
                  ...
                  variants={itemVariants}
                  whileHover={{ y: -4 }}
                  className="group relative overflow-hidden rounded-xl border border-white/10 bg-gradient-to-br from-white/[0.04] to-white/[0.02] p-6 transition-all duration-300 hover:border-[#F3DB3F]/30 hover:shadow-xl"
                >
                  <div className="absolute right-4 top-4 text-4xl font-bold text-white/5">
                    {step.step}
                  </div>
                  <div className="relative">
                    <div className="w-fit rounded-lg bg-[#F3DB3F]/10 p-2">
                      <StepIcon className="size-5 text-[#F3DB3F]" />
                    </div>
        ...
        >
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            >
              <div className="flex items-start gap-4">
                <div className="rounded-lg bg-[#F3DB3F]/10 p-2">
                  <Shield className="size-5 text-[#F3DB3F]" />
                </div>
                <div>
            ...
            >
              <div className="flex items-start gap-4">
                <div className="rounded-lg bg-[#F3DB3F]/10 p-2">
                  <BarChart3 className="size-5 text-[#F3DB3F]" />
                </div>
                <div>
              ...
              {relatedServices.map((relatedService) => {
                ...
                return (
                  <motion.div
                    ...
                    variants={itemVariants}
                    whileHover={{ y: -4 }}
                    className="group rounded-xl border border-white/10 bg-gradient-to-br from-white/[0.04] to-white/[0.02] p-6 transition-all duration-300 hover:border-[#F3DB3F]/30 hover:shadow-xl"
                  >
                    <div className="w-fit rounded-lg bg-[#F3DB3F]/10 p-2">
                      <RelatedIcon className="size-5 text-[#F3DB3F]" />
                    </div>
                    <h3 className="mt-4 text-lg font-semibold text-white transition-colors group-hover:text-[#F3DB3F]">
                      {relatedService.title}
                    </h3>
                    <p className="mt-2 line-clamp-2 text-sm text-[#ECD8D5]/70">
                      {relatedService.summary}
                    </p>
                    <Link
                      href={`/services/${relatedService.slug}`}
                      className="mt-4 inline-flex items-center gap-2 text-sm font-medium text-[#F3DB3F] transition-all hover:gap-3"
                    >
                      Learn More
        ...
        <motion.div
          ...
          className="mt-12 rounded-2xl bg-gradient-to-r from-[#F3DB3F]/10 via-[#8E5F74]/10 to-transparent p-8 text-center"
        >
          ...
          <div className="mt-4 flex items-center justify-center gap-2 text-sm text-[#ECD8D5]/50">
