...
function getStepColor(index: number) {
  const colors = ["#8b5cf6", "#9d70fa", "#D6B520", "#C7A212"];
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <motion.div
          ...
          className="absolute left-0 top-1/2 h-[500px] w-[500px] -translate-y-1/2 rounded-full bg-[#8b5cf6]/5 blur-[100px]"
        />
        <motion.div
          initial={{ opacity: 0 }}
          animate={inView ? { opacity: 0.3 } : {}}
          transition={{ duration: 1, delay: 0.3 }}
          className="absolute right-0 bottom-0 h-[400px] w-[400px] rounded-full bg-[#6d28d9]/10 blur-[100px]"
        />
      </div>
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:gap-12">
          ...
          >
            {/* Glow Effect */}
            <div className="absolute -inset-4 rounded-3xl bg-gradient-to-r from-[#8b5cf6]/5 via-transparent to-transparent blur-2xl" />
                ...
                {enhancedProcessSteps.map((step, index) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="group relative rounded-xl border border-white/10 bg-gradient-to-br from-[rgba(36,14,48,0.72)] to-[rgba(20,4,24,0.78)] p-5 transition-all duration-300 hover:border-[#8b5cf6]/30 hover:shadow-xl"
                    >
                      ...
                      <div className="relative flex gap-4">
                        <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl border border-[#8b5cf6]/30 bg-[#8b5cf6]/10 transition-all duration-300 group-hover:scale-110 group-hover:bg-[#8b5cf6]/20">
                          <Icon className="size-6 text-[#8b5cf6]" />
                        </div>
                        
                        <div className="flex-1">
                          <p className="text-xs font-medium uppercase tracking-wider text-[#8b5cf6]">
                            {step.eyebrow}
                          </p>
                          <h3 className="mt-2 text-xl font-bold text-white group-hover:text-[#8b5cf6] transition-colors">
                            {step.title}
                          </h3>
                          ...
                          {index < enhancedProcessSteps.length - 1 && (
                            <div className="absolute -bottom-4 left-6 hidden h-8 w-px bg-gradient-to-b from-[#8b5cf6]/30 to-transparent lg:block" />
                          )}
                        </div>
                      </div>
                    </motion.div>
          ...
          >
              ...
              return (
                ...
                >
                  ...
                  <div className="relative flex items-start gap-4">
                    <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-[#8b5cf6]/10 transition-all duration-300 group-hover:scale-110">
                      <Icon className="size-6 text-[#8b5cf6]" />
                    </div>
                    ...
                    <div className="flex-1">
                      ...
                      <p className="mt-1 text-sm text-[#a1a1aa]/70">
                        {point.description}
                      </p>
                    </div>
                  </div>
            ...
            <motion.div
              ...
              className="mt-6 rounded-xl border border-[#8b5cf6]/20 bg-gradient-to-r from-[#8b5cf6]/10 to-transparent p-5"
            >
        ...
        >
          <div className="inline-flex flex-col items-center gap-4 rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.03] to-transparent p-8 backdrop-blur sm:flex-row sm:gap-8">
            ...
            <AnimatedButton
              href="/contact"
              // className="bg-gradient-to-r from-[#8b5cf6] to-[#9d70fa] text-white"
            >
