...
export default function AnimatedButton({ href, children, variant = "primary" }: AnimatedButtonProps) {
  const className =
    variant === "primary"
      ? "border border-[#E8C96A]/80 bg-[linear-gradient(135deg,#EDD97A_0%,#E8C96A_55%,#C9A84C_100%)] text-[#0a0a0a] font-semibold shadow-[0_8px_32px_rgba(232,201,106,0.25)] hover:-translate-y-1 hover:shadow-[0_12px_40px_rgba(232,201,106,0.35)]"
      : "border border-white/10 bg-[rgba(255,255,255,0.05)] text-white hover:-translate-y-1 hover:border-[#E8C96A]/40 hover:bg-[rgba(232,201,106,0.08)]";
